...
Page({
  ...
  data: {
    ...
    areaName: '',
    priority: '',
    addUrl: "http://127.0.0.1:8082/demo/superadmin/addarea",
    modifyUrl: "http://127.0.0.1:8082/demo/superadmin/modifyarea"
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: "http://127.0.0.1:8082/demo/superadmin/getareabyid",
